...
if (isset($_SESSION["loggedInUser"])) {
    ...
    $name = $user['name'];
    $query = $pdo->query("SELECT id, title, content, nameuser FROM blogs WHERE iduser= {$_SESSION["loggedInUser"]}");
...
<body>
    ...
    <div class="container-fluid mt-1" style="min-height: 100vh;">
        <h1 class="text-center my-3">Welcome <?= $name ?></h1>
        <p class="text-center">This is the mainpage of OnTopic.</p>
        <?php if (isset($_SESSION["loggedInUser"])): ?>
            <p class="text-center">Click belown to create a new blog.</p>
            <div class="row justify-content-center">
                <div class="col-auto">
                    <p><i class="bi bi-arrow-down display-3"></i></p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-6 my-3">
                    <a href="blogcreate.php"><button type="button" class="btn btn-primary w-100" style="height: 100px;"><i class="bi bi-plus-lg display-5"></i></button></a>
                </div>
            </div>
        ...
        <?php else: ?>
            <p class="text-center">Sign up to create your own blogs.</p>
            <div class="row justify-content-center">
                <div class="col-auto">
                    <p><i class="bi bi-arrow-down display-3"></i></p>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-6 my-3 d-flex justify-content-center">
                    <a href="register.php"><button type="button" class="btn btn-primary rounded-circle"><i class="bi bi-person-add display-1"></i></button></a>
                </div>
            </div>
        <?php endif; ?>
    </div>
